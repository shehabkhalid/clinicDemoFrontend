...
const GQL_CATEGORY_UPDATE = gql`
  mutation($Name: String, $Id: ID) {
    updateCategory(name: $Name, _id: $Id) {
      _id
      name
    }
  }
            ...
            onRowAdd: async (newCategory) => {
              try {
                ...
                setState((oldState) => {
                  ...
                  data.push(newData.data.addCategory);
                ...
                if (oldData) {
                  setState((prevState) => {
                    ...
                    data[data.indexOf(oldData)] =
                      newDataGQL.data.updateCategory;
