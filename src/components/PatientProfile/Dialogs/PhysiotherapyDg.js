...
const [selectedData, setSelectedData] = useState([]);
  ...
  useQuery(GQL_XRAY_QUERY, {
    onCompleted: (data) =>
    {
      const newData = data.physiotherapy.map((e) => e.name);
  ...
  return (
    <div>
      <Dialog
        onClose={props.handleClose("Physiotherapy")}
          ...
          <div className={classes.root2}>
            <div className={classes.set}>
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} variant="standard" label="Physiotherapy" />
                )}
              />
                  ...
                  onClick={async () =>
                    {
                      ...
                      let info = [patient._id,patient.name,cat,'physio']
...
export default PhysiotherapyDg;
